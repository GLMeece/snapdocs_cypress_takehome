...
import {
  notaryCardItem
} from "../page-objects/notary-search-page"
...
describe('Search for Notary by Zip Code', () => {
  ...
  it('should show GPDR cookie notice', () => {
    // Yes, this is a negative test case. 
    // Every other main entry point shows the GPDR cookie notice
  ...
  it('Read more leads to correct Bio', () => {
    ...
    cy.get(notaryCardItem(1)).then(($notaryName1) => {
      ...
      cy.get(':nth-child(1) > td > .media > .media-body > .notary-bio > a').click()
