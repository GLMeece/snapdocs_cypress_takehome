...
describe("Perfect Closing Signup page", () => {
  ...
  it("Lender sign-up fields functional; should trigger CAPTCHA", () => {
  ...
  it("Title / Escrow sign-up fields functional; should trigger CAPTCHA", () => {
  ...
  it("Signing Service sign-up fields functional; should trigger CAPTCHA", () => {
  ...
  it("Notary signing agent sign-up fields functional; should trigger CAPTCHA", () => {
    ...
    cy.get(returnFieldSelector("email", "notary_form")).type(
      "ntorry@stampies.com"
    );
